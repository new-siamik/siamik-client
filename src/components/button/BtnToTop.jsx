...
export default function BtnTopTop() {
    ...
    return (
        ...
        className={
            classes(buttontotop ? 'right-8': "-right-20", 'sm:w-10 w-[1.5rem] text-yellow-600 sm:hover:bg-yellow-600 sm:hover:text-neutral-200 sm:hover:p-1 sm:hover:rounded-full fixed bottom-4 cursor-pointer')
        }
        onClick={() => {
            window.scroll({
                top: 0,
