...
export default function BtnTopTop() {
    ...
    return (
        ...
        className={
            classes(buttontotop ? 'right-8': "-right-20", 'sm:w-10 w-[1.5rem] text-yellow-600 hover:bg-white hover:text-green-base hover:p-1 hover:rounded-full fixed bottom-4 cursor-pointer')
        }
        onClick={() => {
            window.scroll({
                top: 0,
